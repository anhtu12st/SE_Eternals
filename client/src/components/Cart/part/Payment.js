    ...
    <>
      ...
      <div className="mt-8 max-w-lg">
        <div className="grid grid-cols-3 shadow-sm gap-x-3 " role="group">
          <button
            type="button"
            className="flex flex-col items-center justify-center rounded-xl bg-white-1 text-2xl font-medium  py-4 text-gray-900 hover:bg-brown-3 hover:text-brown-1 focus:bg-brown-3 focus:z-10 focus:ring-2 focus:ring-brown-1 focus:text-brown-1"
          >
            <BsCash />
